 ...
 */
conversionSettingsSchema.statics.getActiveSettings = async function (
  currency = "USD"
) {
 ...
 */
conversionSettingsSchema.statics.updateSettings = async function (
  currency,
  updateData,
  adminId
) {
...
const ConversionSettings = mongoose.model(
  "ConversionSettings",
