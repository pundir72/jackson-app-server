 ...
 */
walletAuditLogSchema.statics.getUserAuditLogs = async function(userId, limit = 50) {
 ...
 */
walletAuditLogSchema.statics.getAdminActions = async function(adminId, limit = 100) {
