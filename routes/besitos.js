 ...
 */
router.get('/offers', auth, besitosController.getOffers);
 ...
 */
router.get('/user-data/:userId', auth, besitosController.getUserData);
 ...
 */
router.get('/surveys/:userId', auth, besitosController.getSurveysWall);
 ...
 */
router.get('/user-profiling/:userId', auth, besitosController.getUserProfiling);
 ...
 * @access  Private
 */
router.get('/messenger', auth, besitosController.getMessenger);
 ...
 * @access  Private
 */
router.post('/conversion', auth, besitosController.submitConversion);
 ...
 */
router.get('/conversions', auth, adminAuth, besitosController.getConversions);
